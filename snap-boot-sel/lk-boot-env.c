...
void print_usage() {
    printf("usage:\n"
           ...
           "\t\t[-x, --recovery-0-part=<<recovery image 0 part name>]\n"
           "\t\t[-y, --recovery-1-part=<<recovery image 0 part name>]\n"
           "\n");
}
...
int main (int argc, char **argv) {
    ...
    static struct option long_options[] = {
        ...
        {"recovery-0-part", required_argument, 0, 'x'},
        {"recovery-1-part", required_argument, 0, 'y'},
        {0, 0, 0, 0 }
    };
    ...
    while ((opt = getopt_long(argc, argv, "w:r:u:ha:b:c:d:e:f:g:i:j:k:l:m:n:o:p:q:s:t:",
        ...
        switch (opt) {
          ...
          case 'x' :
              ...
              strncpy(bootSel->unused_key_01, optarg, SNAP_NAME_MAX_LEN);
              break;
          case 'y' :
              if(!optarg) {
                  printf( "Missing argument for %c option\n", opt);
              ...
              strncpy(bootSel->unused_key_02, optarg, SNAP_NAME_MAX_LEN);
              break;
          break;
          case 'h' :
          default:
